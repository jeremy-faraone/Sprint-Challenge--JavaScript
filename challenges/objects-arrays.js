...
const tyrannosaurus ={
  diet:"carnivorous", diet:"7000kg", length:"12m", period:"Late Cretaceous", roar: function(){
    return "RAWERSRARARWERSARARARRRR"
   }
};
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = {
  diet:"herbivorous", diet:"2000kg", length:"9m", period:"Late Jurassic"
};
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor ={
  name: "velociraptor", diet:"carnivorous", diet:"15kg", length:"1.8m", period:"Late Cretaceous"
};
...
for(i= 0; i < zooAnimals.length; i++){
  if(zooAnimals[i].animal_name === zooAnimals[i].animal_name) {
